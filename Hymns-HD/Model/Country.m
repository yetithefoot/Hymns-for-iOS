...
+(NSArray *)allCountries{
    ...
    if(!countries){
...

        {
            ...
            [countries addObject:[Country countryWithName:@"Congo" andCode:@"CD"]];
            [countries addObject:[Country countryWithName:@"Central African Republic" andCode:@"CF"]];
            [countries addObject:[Country countryWithName:@"Congo" andCode:@"CG"]];
            ...
            [countries addObject:[Country countryWithName:@"United Kingdom" andCode:@"GB"]];
            [countries addObject:[Country countryWithName:@"United Kingdom" andCode:@"UK"]];
            ...
            [countries addObject:[Country countryWithName:@"Democratic Lao People's Republic" andCode:@"LA"]];
            ...
            [countries addObject:[Country countryWithName:@"Pitcairn" andCode:@"PN"]];
            ...
            [countries addObject:[Country countryWithName:@"Timor-Leste" andCode:@"TL"]];
            ...
            [countries addObject:[Country countryWithName:@"Samoa" andCode:@"WS"]];
